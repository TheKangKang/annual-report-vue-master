<template>
  <div v-swipeup="changePage" v-swipedown="previousPage">
    <div class="canteenFirst" id="canteenFirst" :style="cssVar" >
      <!--      //文案-->
      <div class="text_pop">
        <div data-aos="fade-zoom-in"
          ...
          <div class="myText">
            ...
            <div>你消费最多的食堂是<br>
              <span>{{canteen}}</span>食堂</div>
            <div>共计消费金额<span>{{totalCost}}</span> <br>
            元</div><br>
          </div>
      ...
      <div class="circle"><img src="../../../assets/images/icon/circle4.png" height="120px" width="120px"> </div>
      <div class="arrow"><img src="../../../assets/images/icon/arrow.png" height="60px" width="80px"></div>
...
export default {
  ...
  methods: {
    changePage() {
      this.$router.push({path: '/girl/canteen/second'})
    },
    previousPage(){
      this.$router.back()
    },
    get(){
      ...
      console.log(data)
      this.canteen = data['most_consume_money_canteen']
      this.totalCost = data['most_consume_canteen_money']
    }
  }
}
</script>
...
<style scoped>
.canteenFirst{
  background: url("../../../assets/images/back/background4.png") no-repeat;
