<template>
  <div v-swipeup="changePage" v-swipedown="previousPage">
    <div class="wescoolFirst" id="wescoolFirst" :style="cssVar" >
      <!--      //文案-->
      <div class="text_pop">
        <div data-aos="fade-zoom-in"
          ...
          <div class="myText">
            ...
            <div>你2022累计使用校园网<br>
              时长是<span>{{totalHours}}小时</span></div>
            <div>累计使用<span>{{totalUse}}G</span><br>
              </div><br>
          </div>
      ...
      <div class="circle"><img src="../../../assets/images/icon/circle6.png" height="120px" width="120px"> </div>
      <div class="globe"><img src="../../../assets/images/icon/globe2.png" height="100px" width="100px"></div>
      <div class="arrow"><img src="../../../assets/images/icon/arrow3.png" height="60px" width="80px"></div>
...
export default {
  ...
  methods: {
    changePage() {
      this.$router.push({path: '/girl/weschool/second'})
    },
    previousPage(){
      this.$router.back()
    },
    get(){
      ...
      console.log(data)
      this.totalHours = data['sum_web_time']
      this.totalUse = data['sum_web_flow']
    }
  }
}
</script>
...
<style scoped>
.wescoolFirst{
  background: url("../../../assets/images/back/background6.png") no-repeat;
